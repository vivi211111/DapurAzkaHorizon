...
const slides = [
  {
    ...
    description: "Kelezatan Maksubah kualitas premium dengan rasa otentik dan tekstur lembut. Sempurna untuk momen spesial Anda.",
  ...
  },
  {
    ...
    description: "Nikmati Lapis Legit Original kami, dibuat dengan resep tradisional dan bahan-bahan pilihan terbaik.",
  ...
  },
  {
    ...
    description: "Perpaduan unik rasa Engkak dengan aroma durian yang khas. Pilihan tepat untuk pecinta durian.",
  ...
  },
   {
    ...
    description: "Kue Lapan Jam dengan sentuhan keju premium, memberikan pengalaman rasa yang mewah dan tak terlupakan.",
...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className={`relative w-full h-[calc(100vh-80px)] md:h-[550px] overflow-hidden ${currentSlide.bgColor}`}>
      <AnimatePresence initial={false} custom={currentIndex}>
        ...
        >
          <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0 z-10">
            ...
            <motion.p 
              className={`text-lg ${currentSlide.textColor} mb-6`}
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            ...
            >
              <Button 
                ...
                className={`${currentSlide.buttonColor} text-white px-8 py-3 rounded-lg text-lg shadow-md hover:shadow-lg transition-shadow`}
              >
          ...
          <div className="md:w-1/2 flex justify-center items-center z-0">
             <motion.div 
              ...
              >
                <img  alt={currentSlide.imageAlt} className="w-full h-full object-cover" src="https://images.unsplash.com/photo-1675023112817-52b789fd2ef0" />
             </motion.div>
          </div>
        </motion.div>
      </AnimatePresence>
      ...
      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2 z-20">
        {slides.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full ${currentIndex === index ? 'bg-orange-500 scale-125' : 'bg-gray-300 hover:bg-gray-400'} transition-all`}
